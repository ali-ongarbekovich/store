...
class ControllerCatalogBossTestimonialSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('catalog/boss_testimonial_setting', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = array(
			'href'      => $this->url->link('catalog/boss_testimonial_setting', 'user_token=' . $this->session->data['user_token'], 'SSL'),
		...
		$data['action'] = $this->url->link('catalog/boss_testimonial_setting', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['cancel'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/boss_testimonial_setting', $data));
	}
