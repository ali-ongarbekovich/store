...
class ControllerExtensionModuleBossRevolutionSlider extends Controller {
	...
	public function index() {
		$this->language->load('extension/module/boss_revolutionslider');
		...
		$data['config_lang'] = $this->config->get('config_language_id');
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/boss_revolutionslider', 'user_token=' . $this->session->data['user_token'], 'SSL'),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/module/boss_revolutionslider', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', 'SSL');

		$data['modulesetting'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['slider_list'] = $this->url->link('extension/module/boss_revolutionslider/sliderlist', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		if(!empty($module_info)){
			...
			$data['slider'] = array(
				...
				'edit_link' => $this->url->link('extension/module/boss_revolutionslider/sliderlist', 'user_token=' . $this->session->data['user_token'] . '&slider_id=' . $module_info['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL'),
				'setting_link' => $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'user_token=' . $this->session->data['user_token'] . '&slider_id=' . $module_info['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL'),
				'total' => $total_slide
			);
		...
		$this->response->setOutput($this->load->view('extension/module/boss_revolutionslider/boss_revolutionslider', $data));
	}
	...
	public function moduleSetting(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (!isset($this->request->get['module_id'])) {
				...
				$this->model_setting_module->addModule('boss_revolutionslider', $this->request->post['module']);
				...
				$this->model_setting_module->editModule($this->request->get['module_id'], $this->request->post['module']);
				$this->model_bossthemes_boss_revolutionslider->editSlider($slider_id,$this->request->post);
				
				$this->session->data['success'] = $this->language->get('text_success');
				$this->response->redirect($this->url->link('extension/module/boss_revolutionslider', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], 'SSL'));
			}
		}
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'user_token=' . $this->session->data['user_token'].'&slider_id='.$slider_id, 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'user_token=' . $this->session->data['user_token'].'&slider_id='.$slider_id.'&module_id='.$this->request->get['module_id'], 'SSL');
		}

		if (!isset($this->request->get['module_id'])) {
			$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider', 'user_token=' . $this->session->data['user_token'], 'SSL');
		} else {
			$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider', 'user_token=' . $this->session->data['user_token'].'&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$this->response->setOutput($this->load->view('extension/module/boss_revolutionslider/boss_revolutionslider_setting', $data));
	}
	...
	public function sliderlist(){
		...
		$data['action'] = $this->url->link('extension/module/boss_revolutionslider/setting', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider', 'user_token=' . $this->session->data['user_token'].'&module_id=' . $this->request->get['module_id'], 'SSL');

		$data['slider_form'] = $this->url->link('extension/module/boss_revolutionslider/sliderform', 'user_token=' . $this->session->data['user_token'], 'SSL');

		$data['modulesetting'] = $this->url->link('extension/module/boss_revolutionslider/moduleSetting', 'user_token=' . $this->session->data['user_token'].'&slider_id='.$this->request->get['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL');

		$data['new_slide'] = $this->url->link('extension/module/boss_revolutionslider/sliderform', 'user_token=' . $this->session->data['user_token'].'&slider_id='.$this->request->get['slider_id'].'&slide_id=0'.'&module_id=' . $this->request->get['module_id'], 'SSL');
		...
		foreach($slides as $slide){
			$data['slides'][] = array(
				...
				'edit_link' => $this->url->link('extension/module/boss_revolutionslider/sliderform', 'user_token=' . $this->session->data['user_token'] . '&slide_id=' . $slide['id'].'&slider_id=' . $slide['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL'),
				'delete_link' => $this->url->link('extension/module/boss_revolutionslider/deleteSlide', 'user_token=' . $this->session->data['user_token'] . '&slide_id=' . $slide['id'].'&module_id=' . $this->request->get['module_id'], 'SSL')
			);
		}
		...
		$this->response->setOutput($this->load->view('extension/module/boss_revolutionslider/boss_revolutionslider_slider_list', $data));
	}
	...
	public function sliderform(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/module/boss_revolutionslider/sliderlist', 'user_token=' . $this->session->data['user_token'].'&slider_id='.$slider_id.'&module_id=' . $this->request->get['module_id'], 'SSL'));
		}
		...
		$data['class_css']= array("big_white","big_white_border","greenbox30","white_bold_bg_20","black_bold_bg_20","red_bold_bg_20","blue_bold_bg_20","grey_heavy_72","white_heavy_40","grey_regular_18","black_bold_40","black_heavy_60","black_heavy_70","black_thin_34","white_thin_34","middle_yellow","big_orange","big_black","big_black_border","medium_white","medium_black","small_text","white_italic","black_italic","medium_text","large_text","large_white_text","very_large_text","very_large_white_text","bold_red_text","bold_brown_text","bold_green_text","very_big_white","very_big_black");
		...
		$data['action'] = $this->url->link('extension/module/boss_revolutionslider/sliderForm', 'user_token=' . $this->session->data['user_token'].'&slide_id='.$slide_id.'&slider_id='.$slider_id.'&module_id=' . $this->request->get['module_id'], 'SSL');

		$data['cancel'] = $this->url->link('extension/module/boss_revolutionslider/sliderlist', 'user_token=' . $this->session->data['user_token'].'&slider_id='.$slider_id.'&module_id=' . $this->request->get['module_id'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/module/boss_revolutionslider/boss_revolutionslider_slider_form', $data));
	}
	...
	public function deleteSlide(){
		...
		if (isset($this->request->get['slide_id']) && !empty($this->request->get['slide_id'])) {
			...
			$json['redirect'] = $this->url->link('extension/module/boss_revolutionslider/sliderlist&user_token=' . $this->session->data['user_token']. '&slider_id=' . $this->request->get['slider_id'].'&module_id=' . $this->request->get['module_id'], 'SSL');
		}
	...
	protected function validate() {
		...
		if (!$this->user->hasPermission('modify', 'extension/module/boss_revolutionslider')) {
	...
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "btslider`, `" . DB_PREFIX . "btslider_slide`");
	}
}
?>