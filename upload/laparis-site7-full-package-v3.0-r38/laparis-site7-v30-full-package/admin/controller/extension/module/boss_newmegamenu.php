...
class ControllerExtensionModuleBossNewmegamenu extends Controller {
	...
	public function index() {
		$this->load->language('extension/module/boss_newmegamenu');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			//$this->model_setting_setting->editSetting('module_boss_newmegamenu', $this->request->post);
			if (!isset($this->request->get['module_id'])) {
				$this->model_setting_module->addModule('boss_newmegamenu', $this->request->post);
				...
				$this->response->redirect($this->url->link('extension/module/boss_newmegamenu', 'user_token=' . $this->session->data['user_token'].'&module_id='.$this->request->get['module_id'], 'SSL'));
			}
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('module/banner', 'user_token=' . $this->session->data['user_token'], 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/boss_newmegamenu', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/boss_newmegamenu', 'user_token=' . $this->session->data['user_token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/module/boss_newmegamenu', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		$this->response->setOutput($this->load->view('extension/module/boss_newmegamenu', $data));
	}
	...
	public function saveMenu(){
		...
		$json['redirect'] = $this->url->link('extension/module/boss_newmegamenu&user_token=' . $this->session->data['user_token'].'&module_id='.$this->request->get['module_id'], 'SSL');
	...
	public function saveMenuRow(){
		...
		$this->language->load('extension/module/boss_newmegamenu');
	...
	public function addMenu(){
		...
		$json['output'] = $this->load->view('extension/module/boss_newmegamenu_addmenu', $data);
		$this->response->addHeader('Content-Type: application/json');
		$this->response->setOutput(json_encode($json));
	}
	...
	public function addMenuRow(){
		...
		$json['output'] = $this->load->view('extension/module/boss_newmegamenu_addrow', $data);
		$this->response->addHeader('Content-Type: application/json');
		$this->response->setOutput(json_encode($json));
	}
	...
	public function addMenuColumn(){
		...
		$json['output'] = $this->load->view('extension/module/boss_newmegamenu_addcolumn', $data);
		$this->response->addHeader('Content-Type: application/json');
		$this->response->setOutput(json_encode($json));
	}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/module/boss_newmegamenu')) {
	...
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "megamenu`, `" . DB_PREFIX . "megamenu_column`, `" . DB_PREFIX . "megamenu_description`, `" . DB_PREFIX . "megamenu_row`");
	}
}
?>