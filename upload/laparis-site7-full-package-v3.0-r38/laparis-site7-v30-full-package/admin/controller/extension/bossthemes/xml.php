<?php
class ControllerExtensionBossthemesXml extends Controller {
	private $error = array();
	
	public function index() {
		$this->load->language('extension/bossthemes/xml');
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'], true)
		);
		
		$data['refresh'] = $this->url->link('extension/bossthemes/xml/refresh', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/bossthemes/xml/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['modifications'][] = array(
				...
				'link'            => $result['link'],
				'enable'          => $this->url->link('extension/bossthemes/xml/enable', 'user_token=' . $this->session->data['user_token'] . '&modification_id=' . $result['modification_id'], true),
				'disable'         => $this->url->link('extension/bossthemes/xml/disable', 'user_token=' . $this->session->data['user_token'] . '&modification_id=' . $result['modification_id'], true),
		...
		if ($directories) {
			$data['error_temporary'] = $this->language->get('error_temporary');
		} else {
			$data['error_temporary'] = '';
		}
		...
		$data['sort_name'] = $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_author'] = $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . '&sort=author' . $url, true);
		$data['sort_version'] = $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . '&sort=version' . $url, true);
		$data['sort_status'] = $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . '&sort=date_added' . $url, true);
		...
		$pagination->url = $this->url->link('extension/bossthemes/xml', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$data['clear_log'] = $this->url->link('extension/bossthemes/xml/clearlog', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/bossthemes/xml', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/bossthemes/xml')) {
	...
	public function refresh($data = array()) {
		...
		if (!isset($data['silent'])) $this->getList();
	}
	...
	public function upload() {
		...
		if (!$json) {
			if (!empty($this->request->files['file']['name'])) {
				if (substr($this->request->files['file']['name'], -10) != '.ocmod.xml') {
			...
			if (strrchr($this->request->files['file']['name'], '.') == '.xml') {
				...
				if (file_exists($file)) {
					$json['step'][] = array(
						...
						'url'  => str_replace('&amp;', '&', $this->url->link('extension/bossthemes/xml/xml', 'user_token=' . $this->session->data['user_token'], true)),
						'path' => $path
					);
					...
					$json['step'][] = array(
						...
						'url'  => str_replace('&amp;', '&', $this->url->link('extension/bossthemes/xml/remove', 'user_token=' . $this->session->data['user_token'], true)),
						'path' => $path
					);
				} else {
