...
$(document).ready(function() {
	...
	$(document).delegate('.modalbox', 'click', function(e) {
				...
				$('#modal-iframe').on('load', function(event) {
						...
						if (current_url.indexOf('marketplace/extension') > -1) {
							...
							iframe.contents().find('#header,#content .page-header .breadcrumb,#column-left,#footer').remove();
