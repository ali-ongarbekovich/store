...
class ControllerCatalogBossTestimonial extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token']. $url, 'SSL'));
		}
	...
	private function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'),
			'separator' => ' :: '
		);


		$data['insert'] = $this->url->link('catalog/boss_testimonial/insert', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('catalog/boss_testimonial/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['module_settings_path'] = $this->url->link('catalog/boss_testimonial_setting', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['text_module_settings'] = $this->language->get('text_module_settings');
		$data['module_testimonial_path'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('catalog/boss_testimonial/update', 'user_token=' . $this->session->data['user_token']. '&testimonial_id=' . $result['testimonial_id'] . $url, 'SSL')
		...
		$data['sort_title'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=td.title' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=t.date_added' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=t.status' . $url, 'SSL');
		$data['sort_name'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=t.name' . $url, 'SSL');
		$data['sort_description'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . '&sort=td.description' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/boss_testimonial_list', $data));
	...
	private function getForm($is_edit) {
		...
		$data['module_settings_path'] = $this->url->link('catalog/boss_testimonial_setting', 'user_token=' . $this->session->data['user_token'], 'SSL');
		$data['text_module_settings'] = $this->language->get('text_module_settings');
		$data['module_testimonial_path'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] , 'SSL');
		$data['text_module_testimonial'] = $this->language->get('text_module_testimonial');
		if (isset($this->error['warning'])) {
			$data['error_warning'] = $this->error['warning'];
		} else {
		...
		if (!isset($this->request->get['testimonial_id'])) {
			$data['action'] = $this->url->link('catalog/boss_testimonial/insert', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('catalog/boss_testimonial/update', 'user_token=' . $this->session->data['user_token'] . '&testimonial_id=' . $this->request->get['testimonial_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('catalog/boss_testimonial', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		if ($data['avatar']) {
			$data['thumb'] = $this->model_tool_image->resize($data['avatar'], 100, 100);
		} else {
		...
		$this->response->setOutput($this->load->view('catalog/boss_testimonial_form', $data));
	}
