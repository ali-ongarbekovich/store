	...
	private $error = array(); 
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
    	}
  	...
  	private function getList() {				
        ...
        $data['breadcrumbs'][] = array(
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'),       		
      		'separator' => ' :: '
   		);
		
		$data['insert'] = $this->url->link('bossblog/articles/insert', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');	
		$data['delete'] = $this->url->link('bossblog/articles/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
    	$data['repair'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['articles'] = array();
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('bossblog/articles/update', 'user_token=' . $this->session->data['user_token'] . '&blog_article_id=' . $result['blog_article_id'] . $url, 'SSL')
			);
			...
			if (is_file(DIR_IMAGE . $result['image'])) {
      		...
      		$data['articles'][] = array(
				...
				'action'     => $action,
				'edit'       => $this->url->link('bossblog/articles/update', 'user_token=' . $this->session->data['user_token'] . '&blog_article_id=' . $result['blog_article_id'], 'SSL')
			);
    	}
		...
		$data['sort_name'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=bad.name' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=ba.date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=ba.date_modified' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=ba.sort_order' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, 'SSL');
		$data['sort_model'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=p.model' . $url, 'SSL');
		$data['sort_price'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=p.price' . $url, 'SSL');
		$data['sort_quantity'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=p.quantity' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, 'SSL');
		$data['sort_order'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('bossblog/articles_list', $data));
  	}
  	...
  	private function getForm() {
		...
		if (!isset($this->request->get['blog_article_id'])) {
			$data['action'] = $this->url->link('bossblog/articles/insert', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('bossblog/articles/update', 'user_token=' . $this->session->data['user_token'] . '&blog_article_id=' . $this->request->get['blog_article_id'] . $url, 'SSL');
		}
		
		$data['cancel'] = $this->url->link('bossblog/articles', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
       ...
       if (isset($this->request->post['date_modified'])) {
		...
		if (isset($this->request->post['article_store'])) {
       	...
       	if (isset($this->request->post['seo_url'])) {
			...
			$data['seo_url'] = $this->model_bossblog_articles->getArticleSeoUrls($this->request->get['blog_article_id']);
		} else {
			$data['seo_url'] = array();
		}
		...
		$this->response->setOutput($this->load->view('bossblog/articles_form', $data));
  	} 
