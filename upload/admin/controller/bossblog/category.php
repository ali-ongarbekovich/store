...
class ControllerBossblogCategory extends Controller { 
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('bossblog/category', 'user_token=' . $this->session->data['user_token'], 'SSL')); 
		}
	...
	private function getList() {
        ...
        $data['breadcrumbs'][] = array(
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('bossblog/category', 'user_token=' . $this->session->data['user_token'], 'SSL'),
      		'separator' => ' :: '
   		);
									
		$data['insert'] = $this->url->link('bossblog/category/insert', 'user_token=' . $this->session->data['user_token'], 'SSL');
		$data['delete'] = $this->url->link('bossblog/category/delete', 'user_token=' . $this->session->data['user_token'], 'SSL');
		$data['repair'] = $this->url->link('bossblog/category', 'user_token=' . $this->session->data['user_token'], 'SSL');
		/*  New Boss Blog */
		...
		foreach ($results as $result) {
			...
			$data['categories'][] = array(
				...
				'edit'        => $this->url->link('bossblog/category/update', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] , 'SSL'),
				'delete'      => $this->url->link('bossblog/category/delete', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] , 'SSL')
			);
		}
		...
		$this->response->setOutput($this->load->view('bossblog/category_list', $data));
	}
	...
	private function getForm() {
       ...
       //$this->document->addStyle('view/stylesheet/bossthemes/bossblog.css');
		...
		if (!isset($this->request->get['blog_category_id'])) {
			$data['action'] = $this->url->link('bossblog/category/insert', 'user_token=' . $this->session->data['user_token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('bossblog/category/update', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $this->request->get['blog_category_id'], 'SSL');
		}
		
		$data['cancel'] = $this->url->link('bossblog/category', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		if (isset($this->request->post['seo_url'])) {
			...
			$data['seo_url'] = $this->model_bossblog_category->getCategorySeoUrls($this->request->get['blog_category_id']);
		} else {
			$data['seo_url'] = array();
		}
		...
		$this->response->setOutput($this->load->view('bossblog/category_form', $data));
	}
